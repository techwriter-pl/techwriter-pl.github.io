...
W systemie opisanym poniżej, Roman pracuje od początku zatrudnienia w firmie (3 lata). Jego wynagrodzenie jest podzielone w następujący sposób:
...
W systemie opisanym poniżej, Ryszard pracuje od początku zatrudnienia w firmie (6 miesięcy). Jego wynagrodzenie jest podzielone w następujący sposób:
...
Co miesiąc Ryszard jest zobowiązany raportować swoją pracę w wewnętrznym systemie. Polega to na dodaniu próbki wykonanej pracy, opisaniu jej oraz uzasadnieniu dlaczego jest to praca twórcza o indywidualnym charakterze. Żeby wysłać raport, Ryszard musi zatwierdzić oświadczenie, że zaraportowana próbka jest autorska. Następnie raport jest akceptowany przez przełożonego. System przypomina Ryszardowi o obowiązku wypełnienia raportu oraz wysyła powiadomienia, np. o akceptacji raportu. W danym miesiącu istnieje możliwość nieraportowania żadnej pracy twórczej. Wtedy do całości wynagrodzenia mają zastosowanie zwykłe koszty pracownicze.
