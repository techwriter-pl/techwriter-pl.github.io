---
title: 'Zanim dodasz wideo - kiedy multimedia w dokumentacji użytkownika mają sens.'
authors: magdazaczek
date: '2026-05-19'
tags:
  - 'warsztat'
  - 'multimedia'
  - 'wideo'
coverImage: 'zanim-dodasz-wideo-cover.png'
---
...
O początkach trendu umieszczania wideo w dokumentacji technicznej pisała już kilka lat temu Martyna Toporek w artykule pt. [Ilustracje i wideo w dokumentacji technicznej](https://techwriter.pl/ilustracje-i-wideo-w-dokumentacji-technicznej/). W mojej publikacji chciałabym pokazać, jak sytuacja wygląda kilka lat później, a także odpowiedzieć na pytanie kiedy tworzenie multimediów w postaci wideo czy interaktywnych treści ma sens w dokumentacji użytkownika. 
...
![Przykład strony z dokumentacji użytkownika od Canva, na której jest materiał wideo.](./images/canva-example.png)
...
![Przykład strony z dokumentacji użytkownika od Atlassian Loom, na której jest materiał wideo.](./images/loom-example.png)
...
![Przykład strony z dokumentacji użytkownika od Camtasia, na której jest sekcja z materiałami wideo.](./images/camtasia-example.png)
...
![Przykład strony z dokumentacji użytkownika od Motoroli, na której jest interaktywne demo.](./images/motorola-example.png)
